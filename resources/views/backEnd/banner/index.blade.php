      ...
      $(".ProductStatus").change(function()
        {
          ...
          if($(this).prop("checked")==true)
          {
            $.ajax({
                ...
                type:'post',
                url: '/admin/update-slideshow-status',
                data: {status:'1',id:id},
...
<section class="content-header">
  <h1>
    <i class="fas fa-database"></i> &nbsp;Slideshow
    <a href="{{route('banner.index')}}" class="btn btn-primary btn-sm"><i class="fas fa-sync-alt"></i></a>
        ...
        <div class="box-body table-responsive">
            <table id="table_dashboard" class="table table-hover table-striped table-bordered">
              ...
              @foreach($banner as $row)
                <tr>
                  <td><center><img src="{{asset('uploads/banner/'.$row->image)}}" height="50px" width="80px" alt=""></center></td>
                  ...
                  <td>
                    <div class="button_action" style="text-align:right"><a class="btn btn-xs btn-danger btn-detail" title="Detail Data" href="{{ route('banner.show', $row)}}"><i class="fa fa-eye"></i></a>
                      <a class="btn btn-xs btn-success btn-edit" title="Edit Data" href="{{ route('banner.edit', $row)}}"><i class="fa fa-pencil"></i></a>
                      <button class="btn btn-xs btn-warning btn-delete"  data-url="{{ route('banner.destroy', $row)}}" ><i class="fa fa-trash"></i></button>
                    </div>
                  </td>
                </tr>
              @endforeach
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h3 class="modal-title" id="exampleModalLabel">Slideshow Create</h3>
