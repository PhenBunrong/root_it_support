...
@section('title','List webpage')
@section('webpage.index' , 'active')
      ...
      $(".ProductStatus").change(function()
        {
          ...
          if($(this).prop("checked")==true)
          {
            $.ajax({
                ...
                type:'post',
                url: '/admin/update-webpage-status',
                data: {status:'1',id:id},
...
<section class="content-header">
  <h1>
  <i class="fas fa-database"></i> &nbsp;webpage
    <a class="btn btn-primary btn-sm"><i class="fas fa-calendar-alt"></i>&nbsp;Show Date</a>
        ...
        <table id="table_dashboard" class="table table-hover table-striped table-bordered">
              <thead>
                <tr class="active">
                  ...
                  <th width="8%" style="text-align:right"><a href="#">Action</a></th>
              </thead>
              <tbody>
              @foreach($webpage as $row)
              <tr>
                  <td>{{Illuminate\Support\Str::of($row->name)->Limit(10)}}</td>
                  ...
                  <td>
                    <div class="button_action" style="text-align:right">
                      <a class="btn btn-xs btn-danger btn-detail" title="Detail Data" href="{{ route('webpage.show', $row)}}"><i class="fa fa-eye"></i></a>
                      <a class="btn btn-xs btn-success btn-edit" title="Edit Data" href="{{ route('webpage.edit', $row)}}"><i class="fa fa-pencil"></i></a>
                      <button class="btn btn-xs btn-warning btn-delete"  data-url="{{ route('webpage.destroy', $row)}}" ><i class="fa fa-trash"></i></button>
                    </div>
                  </td>
                </tr>
              @endforeach
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h3 class="modal-title" id="exampleModalLabel">Create webpage</h3>
