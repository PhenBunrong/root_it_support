                                ...
                                <table id="table-detail" class="table table-striped">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>Image</td>
                                            <td>
                                                <a target="_blank" href="{{asset('uploads/product/'.$data->image)}}"><img style="max-width:150px" title="Image For Image" src="{{asset('uploads/product/'.$data->image)}}"></a>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                @foreach($dataImage as $id=>$attImage)
                                                    <a target="_blank" href="{{asset('uploads/products/'.$attImage->image)}}"><img src="{{asset('uploads/products/'.$attImage->image)}}" style="max-width:50px" alt="{{($attImage->name)}}"/></a>
                                                @endforeach
                                            </td>
                                        </tr>
                                        <tr>
