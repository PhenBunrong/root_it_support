...
<section class="content-header">
    <h1>
    <i class="fas fa-database"></i> &nbsp;&nbsp;&nbsp;Update Product
    </h1>
    <ol class="breadcrumb">
        <li><a href="#" class="header_a"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active header_a">Update Product</li>
    </ol>
</section>
...
<section class="content" data-aos="fade-up" data-aos-duration="3000">
    <div class="box box-info">
        <div class="box-header with-border">
            <h3 class="box-title"><i class="fas fa-database"></i> &nbsp;Update Product</h3>
        </div>
        <div class="box-body">
                ...
                <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="price" class="form-control @error('price') is-invalid @enderror" id="price" placeholder="price" value="{{ old('price', $product->price) }}">
                                    @error('price')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{$message}}</strong>
                                    </span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="spl_price" class="form-control @error('spl_price') is-invalid @enderror" id="spl_price" placeholder="spl_price" value="{{ old('spl_price', $product->spl_price) }}">
                                    @error('spl_price')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{$message}}</strong>
                                    </span>
                                ...
                                <div class="form-group">
                                    ...
                                    <select type="text" name="category_id" class="form-control @error('category_id') is-invalid @enderror" id="select2_category">
                                            @foreach($categories as $id=> $category)
                                                <option {{ old('category_id', $product->category_id)  == $id ? 'selected' : ''}} value="{{$id}}">{{$category}}</option>
                                            @endforeach
                                    </select>
                                    @error('category_id')
                                    <span class="invalid-feedback" role="alert">
                                ...
                                <div class="form-group">
                                    ...
                                    <select type="text" name="subcategory_id" class="form-control" id="select2_subcategory">
                                            @foreach($subCategory as $id=> $subcategory)
                                                <option {{ old('subcategory_id', $product->subcategory_id)  == $id ? 'selected' : ''}} value="{{$id}}">{{$subcategory}}</option>
                                            @endforeach
                                    </select>
                                </div>
                            </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="qty" class="form-control @error('qty') is-invalid @enderror" id="qty" placeholder="quantity" value="{{ old('qty', $product->qty) }}">
                            @error('qty')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{$message}}</strong>
                            </span>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="tax_amt" class="form-control @error('tax_amt') is-invalid @enderror" id="tax_amt" placeholder="quantity" value="{{ old('tax_amt', $product->tax_amt) }}">
                            @error('tax_amt')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{$message}}</strong>
                            </span>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea name="title" class="form-control @error('title') is-invalid @enderror" id="title" placeholder="title">{{ old('title' , $product->title) }}</textarea>
                            @error('title')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{$message}}</strong>
                            </span>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea id="summernote" name="description" class="form-control @error('description') is-invalid @enderror" id="description" placeholder="description">{{ old('description' , $product->description) }}</textarea>
                            @error('description')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{$message}}</strong>
                            </span>
