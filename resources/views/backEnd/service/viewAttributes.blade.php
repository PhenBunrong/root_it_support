...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active header_a">Service Image Attributes</li>
    </ol>
</section>
            ...
            <div class="box box-info bg-default">
                ...
                <div class="box">
                    <div class="box-header">
                        ...
                        <form action="{{ url('admin/serviceImageAtrr/'.$Service->id)}}" method="POST" enctype="multipart/form-data" class="form-horizontal">
                            @csrf
                        ...
                        <div class="box-body table-responsive no-padding">
                            ...
                            <table id="table_dashboard" class="table table-hover table-striped table-bordered">
                                ...
                                @foreach($productImages as $row)
                                    <tr>
                                        <td>
                                            <center><img src="{{url('uploads/products/'.$row->image)}}" alt="" width="80px" height="70px"></center>
                                        </td>
                                        ...
                                        <td>
                                            <div class="button_action" style="text-align:right"> 
                                                ...
                                                <button class="btn btn-xs btn-warning btn-delete"  data-url="{{url('admin/deleteServiceImageAtrr/'.$row->id)}}"><i class="fa fa-trash"></i></button>
                                            </div>
                                        </td>
                                    <tr>
                                @endforeach
