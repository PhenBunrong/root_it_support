...
<section class="content-header">
  <h1>
  <i class="fas fa-database"></i> &nbsp;Service
    <a href="{{route('service.index')}}" class="btn btn-primary btn-sm"><i class="fas fa-sync-alt"></i></a>
        ...
        <div class="box-body table-responsive">
            <table id="table_dashboard" class="table table-hover table-striped table-bordered">
              ...
              @foreach($service as $row)
                <tr>
                  <td><center><img src="{{asset('uploads/service/'.$row->image)}}" height="70px" width="80px" alt=""></center></td>
                  <td>{!! Illuminate\Support\Str::of($row->name)->Limit(40) !!}</td>
                  <td>{!! Illuminate\Support\Str::of($row->title)->words(20) !!}</td>
                  <td>
                  ...
                  <td>
                    <div class="button_action" style="text-align:right">
                      <a class="btn btn-xs btn-danger btn-detail" title="Detail Data" href="{{ route('service.show', $row)}}"><i class="fa fa-eye"></i></a>
                      <a class="btn btn-xs btn-primary btn-detail" title="Attributes Data" href="{{ url('admin/serviceImageAtrr/'.$row->id)}}"><i class="fa fa-image"></i></a>
                      <a class="btn btn-xs btn-success btn-edit" title="Edit Data" href="{{ route('service.edit', $row)}}"><i class="fa fa-pencil"></i></a>
                      <button class="btn btn-xs btn-warning btn-delete"  data-url="{{ route('service.destroy', $row)}}" ><i class="fa fa-trash"></i></button>
                    </div>
                  </td>
                </tr>
              @endforeach
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h3 class="modal-title" id="exampleModalLabel">Service Create</h3>
