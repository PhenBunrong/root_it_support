...
<section class="content-header">
  <h1>
  <i class="fas fa-database"></i> &nbsp;Brand
    <a href="{{route('brand.index')}}" class="btn btn-primary btn-sm"><i class="fas fa-sync-alt"></i></a>
    ...
    <div class="box-header">
        <div class="box-body table-responsive">
            ...
            <table id="table_dashboard" class="table table-hover table-striped table-bordered">
              ...
              <tr>
                  <td><center><img src="{{asset('uploads/brand/'.$row->image)}}" height="50px" width="100px" alt=""></center></td>
                  <td>{{Illuminate\Support\Str::of($row->name)->Limit(20)}}</td>
                  ...
                  <td>
                    <div class="button_action" style="text-align:right">
                      <a class="btn btn-xs btn-danger btn-detail" title="Detail Data" href="{{ route('brand.show', $row)}}"><i class="fa fa-eye"></i></a>
                      <a class="btn btn-xs btn-success btn-edit" title="Edit Data" href="{{ route('brand.edit', $row)}}"><i class="fa fa-pencil"></i></a>
                      <button class="btn btn-xs btn-warning btn-delete"  data-url="{{ route('brand.destroy', $row)}}" ><i class="fa fa-trash"></i></button>
                    </div>
                  </td>
                </tr>
              @endforeach
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h3 class="modal-title" id="exampleModalLabel">Brand Create</h3>
