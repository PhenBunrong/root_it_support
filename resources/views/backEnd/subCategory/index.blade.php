...
@section('title','List Sub Category')
@section('subCategory.index' , 'active')
...
<section class="content-header">
  <h1>
  <i class="fas fa-database"></i> &nbsp;Sub Category
  ...
  <div class="box">
    <div class="box-header">
        ...
        <table id="table_dashboard" class="table table-hover table-striped table-bordered">
              ...
              <tr>
                  <td><center><img src="{{asset('uploads/subCategory/'.$row->image)}}" height="50px" width="100px" alt=""></center></td>
                  ...
                  <td>
                    <div class="button_action" style="text-align:right">
                      <a class="btn btn-xs btn-danger btn-detail" title="Detail Data" href="{{ route('subCategory.show', $row)}}"><i class="fa fa-eye"></i></a>
                      <a class="btn btn-xs btn-success btn-edit" title="Edit Data" href="{{ route('subCategory.edit', $row)}}"><i class="fa fa-pencil"></i></a>
                      <button class="btn btn-xs btn-warning btn-delete"  data-url="{{ route('subCategory.destroy', $row)}}" ><i class="fa fa-trash"></i></button>
                    </div>
                  </td>
                </tr>
              @endforeach
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h3 class="modal-title" id="exampleModalLabel">Create Sub Category</h3>
