                                ...
                                <table id="table-detail" class="table table-striped">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>Image</td>
                                            <td>
                                                <a target="_blank" href="{{asset('uploads/events/'.$data->image)}}"><img style="max-width:150px" title="Image For Image" src="{{asset('uploads/events/'.$data->image)}}"></a>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                @foreach($dataImage as $id=>$attImage)
                                                    <a target="_blank" href="{{asset('uploads/events/'.$attImage->image)}}"><img src="{{asset('uploads/events/'.$attImage->image)}}" style="max-width:50px" alt="{{($attImage->name)}}"/></a>
                                                @endforeach
                                            </td>
                                        </tr>
                                        <tr>
