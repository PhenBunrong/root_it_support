...
<section class="content-header">
  ...
  <i class="fas fa-database"></i> &nbsp;events
    <a href="{{route('events.index')}}" class="btn btn-primary btn-sm"><i class="fas fa-sync-alt"></i></a>
        ...
        <div class="box-body table-responsive">
            <table id="table_dashboard" class="table table-hover table-striped table-bordered">
              ...
              @foreach($events as $row)
                <tr>
                  <td><center><img src="{{asset('uploads/events/'.$row->image)}}" height="70px" width="80px" alt=""></center></td>
                  ...
                  <td>
                    <div class="button_action" style="text-align:right">
                      <a class="btn btn-xs btn-danger btn-detail" title="Detail Data" href="{{ route('events.show', $row)}}"><i class="fa fa-eye"></i></a>
                    <a class="btn btn-xs btn-primary btn-detail" title="Attributes Data" href="{{ url('admin/eventsImageAtrr/'.$row->id)}}"><i class="fa fa-image"></i></a>
                      <a class="btn btn-xs btn-success btn-edit" title="Edit Data" href="{{ route('events.edit', $row)}}"><i class="fa fa-pencil"></i></a>
                      <button class="btn btn-xs btn-warning btn-delete"  data-url="{{ route('events.destroy', $row)}}" ><i class="fa fa-trash"></i></button>
                    </div>
                  </td>
                </tr>
              @endforeach
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h3 class="modal-title" id="exampleModalLabel">events Create</h3>
