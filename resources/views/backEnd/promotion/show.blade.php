                                ...
                                <table id="table-detail" class="table table-striped">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>Image</td>
                                            <td>
                                                <a target="_blank" href="{{asset('uploads/promotion/'.$data->image)}}"><img style="max-width:150px" title="Image For Image" src="{{asset('uploads/promotion/'.$data->image)}}"></a>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                @foreach($dataImage as $id=>$attImage)
                                                    <a target="_blank" href="{{asset('uploads/promotion/'.$attImage->image)}}"><img src="{{asset('uploads/promotion/'.$attImage->image)}}" style="max-width:50px" alt="{{($attImage->name)}}"/></a>
                                                @endforeach
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td>Sub Category</td>
                                            <td>{{$data->getSubCategory()}}</td>
                                        </tr>
                                        <tr>
                                            <td>Brand</td>
                                            <td>{{$data->getBrandName()}}</td>
                                        </tr>
                                        <tr>
                                            <td>Tax_amt</td>
                                            <td>{{$data->tax_amt}}</td>
