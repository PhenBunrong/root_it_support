...
<div class="breadcrumb_cus">
    <div class="container">
        <ol class="breadcrumb">
			...
			<?php $brand_name= App\Models\Service::where('id',$id_)->get() ?>
        ...
        <div class="row">
            <div class="col-md-6">
                <div id="amazingslider-offer" style="display:block;position:relative;margin-top:0px;margin-bottom:120px;">
                    <ul class="amazingslider-slides">
                        @foreach($imageService as $id=>$attImage)
            ...
            <div class="col-md-6">
                <div class="pro_overview">
                    ...
                    <p><i style="margin-right: 6px;" class="fa fa-calendar"></i>{{($serviceData->created_at->format('d/m/Y'))}}</p>
                <div class="line"></div>
                <ul>
                    <span style="font-family:arial, helvetica, sans-serif;">{!! $serviceData->description !!}</span>
                </ul>
                ...
                <div class="col-md-4 col-sm-4">
                    <div class="event_box">
                        ...
                        <div class="event_title">
                            <h3><a href="{{url('serviceDetail/'.$row->id)}}" title="{{($row->name)}}">{{($row->name)}}<i class="fa fa-calendar-o" aria-hidden="true"></i></a></h3>
                        </div><!-- end event_title -->
                    </div><!-- end event_box -->
                </div><!-- end col -->
            @endforeach
