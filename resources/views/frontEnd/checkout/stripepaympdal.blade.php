        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-12 form-group d-none" style="display:none">
                        ...
                        <div class="row">
                            <div class="col-md-12 text-center">
                                ...
                                <button type="submit" class="myButton2 btn-block">PAY NOW WITH STRIPE</button>
                            </div>
                        </div>
                </div>
            </div>
